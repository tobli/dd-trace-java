...
import datadog.trace.common.writer.ddintake.DDIntakeApi.DDIntakeApiBuilder;
...
public class WriterFactory {
  ...
  public static Writer createWriter(
    ...
    if (DD_INTAKE_WRITER_TYPE.equals(configuredType) || config.isCiVisibilityEnabled()) {
      ...
      if (featuresDiscovery.supportsEvpProxy() && !config.isCiVisibilityAgentlessEnabled()) {
        remoteApi = DDEvpProxyApi.builder()
